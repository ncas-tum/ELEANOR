...
nb_outputs = 20
alpha = float(np.exp(-10. / args.tau_syn)) # Change to real dt
beta = float(np.exp(-10. / args.tau_mem))  # Change to real dt
...
if args.nni:
    ...
    cm_display.plot()
    # plt.savefig("/home/pedro/neuron_pizzo_jax-main/scripts/cm.png")
    # plt.figure()
    # plot_spk_charge(
