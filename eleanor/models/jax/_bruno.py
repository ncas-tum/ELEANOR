...
class Bruno(StatefulLayer):
    ...
    def __init__(
        ...
        *,
        ...
        self.A_var = StaticWrapper(D2DVar("A", variability, shape, k1))
        self.E_a_var = StaticWrapper(D2DVar("E_a", variability, shape, k2))
        self.P_s_var = StaticWrapper(D2DVar("P_s", variability, shape, k3))
        self.I_0_var = StaticWrapper(D2DVar("I_0", variability, shape, k4))
        self.Iin_var = StaticWrapper(D2DVar("Iin", variability, shape, k5))
        self.t_hzo_var = StaticWrapper(D2DVar("t_hzo", variability, shape, k6))
        self.t_int_var = StaticWrapper(D2DVar("t_int", variability, shape, k7))
    ...
    def init_state(
        ...
        """
        init_state_vol = jnp.zeros(shape)
        init_state_pol = -self.P_s_var(self.P_s)
    ...
    def __call__(
        ...
        A = self.A_var(self.A)
        E_a = self.E_a_var(self.E_a)
        P_s = self.P_s_var(self.P_s)
        I_0 = self.I_0_var(self.I_0)
        t_hzo = self.t_hzo_var(self.t_hzo)
        t_int = self.t_int_var(self.t_int)

        # synaptic_input = self.Iin_var(synaptic_input)
